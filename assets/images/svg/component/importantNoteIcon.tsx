...
type SVGComponentProps = {
    size?: number; // Optional size (applies to both width and height)
    color?: string; // Optional fill color for the icon
} & React.ComponentProps<typeof Svg>; // Extend Svg props if needed

// ==============================
//        SVG Component
// ==============================
const SVGComponent: React.FC<SVGComponentProps> = ({ size = 24, color = '#FCFCFC', ...props }) => (
